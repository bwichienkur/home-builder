...
**Status:** E0–E3 shipped (history, wall length/angle/grips, trim/extend/break/offset/copy/mirror, Tab length, hosted openings, soft layer hide in 2D+3D). E4 partial (stories/underlay deferred).  
**Baseline:** CAD Studio after Wave 3 (#301).  
