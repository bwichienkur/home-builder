...
export function FloorPlanEditor(){
 ...
 return <div className="canvas-host" ref={host}><Stage width={size.width} height={size.height} scaleX={scale} scaleY={scale} onMouseMove={move} onTouchMove={move} onMouseDown={down} onTouchStart={down}>
