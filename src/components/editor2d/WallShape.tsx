...
export function WallShape({wall,selected,onSelect,onOpening,onEndpointMove,tool,openings}:{wall:Wall;selected:boolean;onSelect:()=>void;onOpening:(type:'door'|'window')=>void;onEndpointMove:(end:'start'|'end',x:number,y:number)=>void;tool:Tool;openings:Opening[]}){
