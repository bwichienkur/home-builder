 ...
 * Sales funnel + weighted pipeline from Pipedrive Sales pipeline (pulled 2026-09-18T20:08:02.497Z).
...
export const LIVE_SNAPSHOT_AT = '2026-09-18T20:08:01.363Z';
/** Pipedrive Sales pipeline pull timestamp baked into this snapshot (empty when PD cache absent). */
export const LIVE_PIPEDRIVE_AT = '2026-09-18T20:08:02.497Z';
