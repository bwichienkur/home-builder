 ...
 * Sales funnel + weighted pipeline from Pipedrive Sales pipeline (pulled 2026-09-19T11:02:41.598Z).
...
export const LIVE_SNAPSHOT_AT = '2026-09-19T11:02:39.861Z';
/** Pipedrive Sales pipeline pull timestamp baked into this snapshot (empty when PD cache absent). */
export const LIVE_PIPEDRIVE_AT = '2026-09-19T11:02:41.598Z';
